...
export default function TechnologieBento() {
  return (
    <>
      ...
      <Divider />
      <section className="w-full mx-auto mb-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 xl:grid-cols-6 gap-6 auto-rows-[minmax(200px,1fr)]">
        {/* CNC Equipment */}
        <motion.div
          className="col-span-1 md:col-span-1 lg:col-span-4 xl:col-span-4 bg-steel/5 rounded-3xl shadow-sm border border-steel/10 overflow-hidden"
          whileHover={{ y: -5 }}
        >
          <div className="p-6 md:p-8">
            ...
            <div className="mt-4 p-4 border border-steel/20 bg-steel/30 rounded-xl text-sm">
              <span className="font-medium">Dlouhodobá spolehlivost:</span>{" "}
              stále provozujeme jeden stroj z roku 2005 a dva stroje z roku
              2006.
            </div>
        ...
        {/* Metrology */}
        <motion.div
          className="col-span-1 md:col-span-1 lg:col-span-2 xl:col-span-2 bg-steel/5 rounded-3xl shadow-sm border border-steel/10 overflow-hidden"
          whileHover={{ y: -5 }}
        >
          <div className="p-6 md:p-8">
            <h3 className="text-lg md:text-xl font-semibold mb-3 flex items-center gap-2">
        ...
        {/* Software */}
        <motion.div
          className="col-span-1 md:col-span-1 lg:col-span-3 xl:col-span-2 bg-steel/5 rounded-3xl shadow-sm border border-steel/10 overflow-hidden"
          whileHover={{ y: -5 }}
        >
          <div className="p-6 md:p-8">
            <h3 className="text-lg md:text-xl font-semibold mb-3 flex items-center gap-2">
            ...
            <ul className="space-y-3 list-disc pl-6 marker:text-steel">
              <li>
                <span className="font-medium">HELIOS Inuvio</span> – ERP systém
                od <span className="font-medium">Asseco Solutions</span>,
                zajišťující komplexní správu firemních procesů.
              </li>
              <li>
                <span className="font-medium">GibbsCAM</span> – technologický{" "}
                <span className="font-medium">CAD/CAM software</span> pro
                přípravu CNC programů.
              </li>
              <li>
                <span className="font-medium">
        ...
        {/* Left Quote & Intro */}
        <motion.div
          className="col-span-1 md:col-span-1 lg:col-span-6 xl:col-span-4 flex flex-col justify-center p-8 bg-steel/30 rounded-3xl shadow-sm relative overflow-hidden z-10"
          whileHover={{ y: -5 }}
        >
          <div className="mt-6">
